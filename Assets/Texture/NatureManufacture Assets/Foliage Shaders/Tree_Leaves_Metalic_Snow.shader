Shader "NatureManufacture Shaders/Trees/Tree Leaves Metalic Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult51 = lerp( ( lerpResult304 * tex2DNode3 ) , ( tex2D( _SnowAlbedoRGB, uv_SnowAlbedoRGB ) - float4( appendResult100 , 0.0 ) ) , lerpResult290);
			o.Albedo = lerpResult51.rgb;
			float4 tex2DNode28 = tex2D( _MetalicRAOGSmothnessA, uv_MainTex );
			float4 tex2DNode64 = tex2D( _SnowMetalicRAOGSmothnessA, uv_SnowAlbedoRGB );
