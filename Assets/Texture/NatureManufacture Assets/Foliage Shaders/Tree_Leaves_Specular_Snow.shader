Shader "NatureManufacture Shaders/Trees/Tree Leaves Specular Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float4 lerpResult51 = lerp( temp_output_97_0 , ( tex2D( _SnowAlbedoRGB, uv_SnowAlbedoRGB ) - float4( appendResult121 , 0.0 ) ) , lerpResult334);
			o.Albedo = lerpResult51.rgb;
			float4 tex2DNode64 = tex2D( _SnowSpecularRGBSmothnessA, uv_SnowAlbedoRGB );
			...
			float4 tex2DNode98 = tex2D( _AmbientOcclusionGSmothnessA, uv_MainTex );
